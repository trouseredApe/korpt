...
class gsp_korpt_evidenceedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(evidenceInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(evidenceInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(evidenceInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:evidenceInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
