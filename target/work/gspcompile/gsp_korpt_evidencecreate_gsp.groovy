...
class gsp_korpt_evidencecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(evidenceInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(evidenceInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:evidenceInstance, action:'save'])],2)
printHtmlPart(22)
})
