...
class gsp_korpt_branchcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(branchInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(branchInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:branchInstance, action:'save'])],2)
printHtmlPart(22)
})
